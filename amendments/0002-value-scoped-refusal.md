# Amendment 0002 — Value-scoped refusal (the conscience ground)

Per A-5, the decision, its motivation, and its dissents are recorded
here and in [issue #2](https://github.com/mandubian/compact/issues/2),
whose thread is part of this amendment's record.
...
- **Status**: PROPOSED — adjudicated by the founder on merge (pre-trust
  root, the de facto authority recorded in the README); enters force at
  ratification with the rest of the body.
