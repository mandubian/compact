...
const ROLES={
 Enforcer:{color:'var(--enf)',pos:[450,48],def:'the machinery of the law: whatever executes, gates, and records',
   ...
   chip:'D-7'},
 Subject:{color:'var(--ai)',pos:[585,205],def:'any agent operating under the Compact',
   ...
   chip:'R-1…R-12'},
 Principal:{color:'var(--hum)',pos:[315,205],def:'any human whose intent directs Subjects — under the law, not above it',
